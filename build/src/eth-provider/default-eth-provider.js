...
var DefaultEthProvider = /** @class */ (function () {
     ...
     */
    DefaultEthProvider.prototype.connected = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.web3.eth.net.isListening()];
                    case 1:
                        _b.sent();
     ...
     */
    DefaultEthProvider.prototype.getCurrentBlock = function () {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DefaultEthProvider.prototype.getEvents = function (filter) {
        return __awaiter(this, void 0, void 0, function () {
            var contract, events;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, events.map(function (event) {
                                return new models_1.EventLog(event);
                            })];
                }
            });
        });
...
exports.DefaultEthProvider = DefaultEthProvider;
